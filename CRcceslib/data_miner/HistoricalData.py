...
class HistoricalData(object):
    """
    This class provides methods for gathering historical price data on CoinBase RestAPI of a specified
    ...
    def _data_preprocessor(self, data_in, start, end):
        """"""
        data = data_in.copy()
        ...
        data["timestamp"] = data.time.astype("int64") // 10 ** 9
    ...
    def retrieve_data(self):
        ...
        if request_volume <= 300:
            ...
            if response.status_code in [200, 201, 202, 203, 204]:
                ...
                data = self._data_preprocessor(data, start, end)
                if self.verbose:
...
if __name__ == "__main__":
    df = HistoricalData('BTC-USD', 60, '2022-01-01-00-00', '2022-01-06-00-00').retrieve_data()
